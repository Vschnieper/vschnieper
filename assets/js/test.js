    ...
    !(function (b) {
                    ...
                    _create: function () {
                        (this.loader = {}),
                            this.options.enhanced
                                ? ((this.loader.span = this.element.children(
                                      "span"
                                  )),
                                  (this.loader.header = this.element.children(
                                      "h1"
                                  )))
        ...
        (function (b) {
            ...
            return (
                a.extend(a.support, {
                    orientation:
                        "orientation" in b && "onorientationchange" in b,
                }),
                a.support
            );
        }),
        (function (b) {
            ...
            return (
                ...
                (a.mobile.ajaxBlacklist =
                    (b.blackberry && !b.WebKitPoint) || p || k),
                k &&
                    a(function () {
            ...
            function r(c) {
                if (!M) {
                    ...
                    a.data(c.target, "lastTouchType", c.type),
                        (J =
                            J ||
                            Math.abs(d.pageX - H) > g ||
                            Math.abs(d.pageY - I) > g),
                                ...
                                if (!a.event.special.swipe.eventInProgress) {
                                    ...
                                    (e.move = function (b) {
                                        g &&
                                            ...
                                            k ||
                                                ((k = a.event.special.swipe.handleSwipe(
                                                    g,
                                                    d,
                                                    c,
                                                    h
                ...
                (a.event.special.scrollstart = {
                    ...
                    setup: function () {
                        ...
                        var d,
                            ...
                            f = this,
                            g = a(f),
                            h = (a.event.special.scrollstart.handler = function (
                                b
                            ) {
            ...
            return (
                (a.mobile.path = c = {
                    ...
                    isFirstPageUrl: function (b) {
                        var e = c.parseUrl(
                                c.makeUrlAbsolute(b, this.documentBase)
                            ),
                            f =
                ...
                (c.documentBase = e.length
                    ? c.parseUrl(
                          c.makeUrlAbsolute(e.attr("href"), c.documentUrl.href)
                      )
                    : c.documentUrl),
                ...
                a.extend(a.mobile.History.prototype, {
                    ...
                    direct: function (b) {
                        var c = this.closest(b.url, b.id),
                            e = this.activeIndex;
                        c !== d &&
                            ((this.activeIndex = c), (this.previousIndex = e)),
                            e > c
                                ? (b.present || b.back || a.noop)(
                                      this.getActive(),
                                      "back"
                                  )
                                : c > e
                ...
                a.extend(a.mobile.Navigator.prototype, {
                    ...
                    squash: function (f, g) {
                        ...
                        return (
                            (i = d.squash(f)),
                            (h = a.extend(
                                { id: ++this.historyEntryId, hash: j, url: i },
                                g
                            )),
                            b.history &&
                    ...
                    go: function (e, f, g) {
                        ...
                        (i = d.squash(e)),
                            ...
                            l &&
                                ...
                                (k.originalEvent = new a.Event("popstate", {
                                    state: null,
                                })),
            ...
            return (
                ...
                a.extend(a.enhance, {
                    enhance: function (b) {
                        var c,
                            d = b
                                .find("[" + a.enhance.defaultProp() + "]")
                                .addBack();
                        for (
                            a.enhance._filter && (d = a.enhance._filter(d)),
                                c = 0;
            ...
            if (a.mobileBackcompat !== !1) {
                var b = function (b) {
                    ...
                    c = function (b) {
                        return (
                            b.initSelector ||
                            a[b.namespace][b.widgetName].prototype
                                .initSelector ||
                            !1
                        );
                    };
        ...
        (function (b) {
            ...
            return (
                a.widget("mobile.page", {
                    ...
                    _themeElements: function () {
                        return [
                            { element: this.element, prefix: "ui-page-theme-" },
                        ];
                    },
            ...
            return (
                a.widget("mobile.pagecontainer", {
                    ...
                    _filterNavigateEvents: function (b, c) {
                        var d;
                        (b.originalEvent &&
                            b.originalEvent.isDefaultPrevented()) ||
                            ((d =
                    ...
                    load: function (b, c) {
                        var e,
                            ...
                            k = null,
                            l = a.mobile.path.makeUrlAbsolute(
                                b,
                        ...
                        return (
                            j.data &&
                                "get" === j.type &&
                                ((l = a.mobile.path.addSearchParams(l, j.data)),
                                (j.data = d)),
                    ...
                    _releaseTransitionLock: function () {
                        (f = !1),
                            e.length > 0 && this.change.apply(this, e.pop());
                    },
                                    ...
                                    : (b.page({ role: h.role }),
                                      ...
                                      j &&
                                          ...
                                          a.mobile.hashListeningEnabled
                                              ...
                                              : b[0] !==
                                                    a.mobile.firstPage[0] &&
                                                a.mobile.navigate.history.add(
                                                    j,
                                                    t
                                                )),
                                      (c.title = p),
                    ...
                    _themeElements: function () {
                        return [
                            { element: this.element, prefix: "ui-overlay-" },
                        ];
                    },
                    _destroy: function () {
                        var b;
            ...
            return (
                a.each(["animation", "transition"], function (c, g) {
                    ...
                    a.each(f, function (c, f) {
                        ...
                        (b[g].duration = a.camelCase(
                            b[g].prefix + g + "-duration"
                        )),
                        (b[g].event = a.camelCase(b[g].prefix + g + "-end")),
                        "" === b[g].prefix &&
                            (b[g].event = b[g].event.toLowerCase());
                }),
            ...
            return (
                ...
                a.extend(a.mobile.Transition.prototype, {
                    ...
                    cleanFrom: function () {
                        this.$from
                            .removeClass(
                                "ui-page-active out in reverse " + this.name
                            )
                            .height("");
                    },
                    ...
                    startIn: function (b, c, d, e) {
                        this.hideIn(function () {
                            this.$to.addClass(
                                "ui-page-active" + this.toPreClass
                            ),
                        ...
                        return !a.mobile.ajaxEnabled ||
                            ...
                            : ((d =
                              ...
                              d ||
                                  ...
                                  "get" === g &&
                                      (d = i.parseUrl(d).hrefNoSearch),
                                  d === i.documentBase.hrefNoHash &&
                                      (d = j.hrefNoSearch)),
                              (d = i.makeUrlAbsolute(
                                  d,
                              ...
                              i.isExternal(d) &&
                              !i.isPermittedCrossDomainRequest(j, d)
                                  ? !1
                                  : (c ||
                                        ((e = b.serializeArray()),
                                        k &&
                                ...
                                if (
                                    ...
                                    if (
                                        ...
                                        (k =
                                            h ||
                                            (i.isExternal(g) &&
                                                !i.isPermittedCrossDomainRequest(
                                                    j,
                                                    g
                                                ))))
                                    )
                ...
                options: {
                    classes: {
                        ...
                        "ui-page-dialog-contain":
                            "ui-overlay-shadow ui-corner-all",
                    },
                    closeBtn: "left",
                    closeBtnText: "Close",
                    overlayTheme: "a",
                ...
                _setOptions: function (b) {
                    ...
                    this._super(b),
                        this.options.dialog &&
                            ...
                            b.closeBtnText !== d &&
                                ((c = this.options.closeBtn),
                                (e = b.closeBtnText)),
                            b.closeBtn !== d &&
                                ((c = b.closeBtn),
                                (e = e || this.options.closeBtnText)),
                        ...
                        this.dialog.button
                            ...
                            : "none" !== b &&
                              ...
                              d.length &&
                                  ...
                                  (this.dialog.icon = a("<span>").appendTo(
                                      this.dialog.button
                                  )),
                    ...
                    {},
                    {
                        backcompat: {
                            ...
                            _classesToOption: function (c) {
                                if (
                                    this.classProp &&
                                    "string" == typeof c[this.classProp]
                                ) {
                                    var e = this,
                            ...
                            _setInitialOptions: function () {
                                var c,
                                    e = this.options,
                                    f =
                                        a[this.namespace][this.widgetName]
                                            .prototype.options,
                                    g = this.classProp,
                                    h = this;
                                g &&
                                    ...
                                    f.classes[g] !== e.classes[g]
                                        ? a.each(this._boolOptions, function (
                                              b,
                                              f
                                          ) {
                                              e[b] !== d &&
                ...
                a.widget("mobile.collapsible", {
                        ...
                        for (d in c)
                            (c[d] =
                                null != c[d]
                                    ...
                                    : null),
                                null == c[d] &&
                                    (c[d] = a.mobile.collapsible.defaults[d]);
                        return c;
                    },
                    ...
                    _applyOptions: function (a) {
                        ...
                        a.collapsed !== d &&
                            ...
                            b
                                ? l.expandCueText !== d &&
                                  k.text(l.expandCueText)
                                : l.collapseCueText !== d &&
                                  k.text(l.collapseCueText),
                            l.theme !== d &&
                                ((e = this._themeClassFromOption(
                                    "ui-button-",
                                    h.theme
                    ...
                    _destroy: function () {
                        ...
                        b.enhanced ||
                            (a.placeholder
                                ? (a.originalHeading.insertBefore(
                                      a.placeholder
                                  ),
        ...
        (function (b) {
            ...
            return a.widget("ui.controlgroup", {
                            ...
                            ? "controlgroupLabel" === d
                                ...
                                : void (
                                      ...
                                      b.element.find(e).each(function () {
                                          ...
                                          if (
                                              "button" !== d ||
                                              !e.parent(".ui-spinner").length
                                          ) {
                                              f || (f = e[d]()[d]("instance")),
                                                  f &&
                                                      (h.classes = b._resolveClassesValues(
                                                          h.classes,
                                                          f
                                                      )),
                                                  e[d](h);
                ...
                _checkboxradioOptions: function (a) {
                    return this._buildSimpleOptions(
                        a,
                        ...
                        b.length &&
                            (a.each(["first", "last"], function (a, d) {
                                ...
                                if (e && c["_" + e.widgetName + "Options"]) {
                                    ...
                                    (f.classes = c._resolveClassesValues(
                                        f.classes,
                                        e
                                    )),
        ...
        (function (b) {
            "function" == typeof define && define.amd
                ? define("jquery-ui/escape-selector", [
                      "jquery",
                      "./version",
                  ], b)
                : b(a);
            ...
            return (
                a.widget("ui.button", {
                    ...
                    _attachIconSpace: function (a) {
                        this.icon[
                            /^(?:end|bottom)/.test(a) ? "before" : "after"
                        ](this.iconSpace);
                    },
                    _attachIcon: function (a) {
                        this.element[
                            /^(?:end|bottom)/.test(a) ? "append" : "prepend"
                        ](this.icon);
                    },
                    _setOptions: function (a) {
                        var b =
                    ...
                    refresh: function () {
                        ...
                        a !== this.options.disabled &&
                            this._setOptions({ disabled: a }),
                            this._updateTooltip();
                    },
                }),
                a.uiBackCompat !== !1 &&
            ...
            return a.widget("mobile.navbar", {
                ...
                _create: function () {
                    var a = this,
                        ...
                        g = c.filter(":jqmData(icon)").length
                            ? a.options.iconpos
                            : d;
                    b
                        .addClass("ui-navbar")
        ...
        (function (b) {
            ...
            function c(a, b, c) {
                return (
                    a >= c.x && a <= c.x + c.cx && b >= c.y && b <= c.y + c.cy
                );
            }
            function e(a, b) {
                var d = a.offset(),
            ...
            return (
                ...
                a.widget("mobile.popup", {
                    ...
                    _handleWindowKeyUp: function (b) {
                        return this._isOpen &&
                            b.keyCode === a.mobile.keyCode.ESCAPE
                    ...
                    _handleDocumentFocusIn: function (b) {
                        ...
                        if (this._isOpen) {
                            if (d !== e.container[0]) {
                                if (
                                    ((c = a(d)), !a.contains(e.container[0], d))
                                )
                                    return (
                                        a(
                                            a.ui.safeActiveElement(
                    ...
                    _calculateFinalLocation: function (a, b) {
                        ...
                        return (
                            ...
                            (c.top -= Math.min(
                                ...
                                Math.max(
                                    0,
                                    c.top + e.cy - this.document.height()
                                )
                            )),
                            c
                        );
                    ...
                    _openPrerequisitesComplete: function () {
                        ...
                        this._addClass(this._ui.container, "ui-popup-active"),
                            ...
                            this._resizeScreen(),
                            d &&
                                !a.contains(this._ui.container[0], d) &&
                                a.ui.safeBlur(d),
                    ...
                    _closePopup: function (c, d) {
                        ...
                        a.mobile.popup.active !== this ||
                            ...
                            c &&
                                ...
                                this._pageUrl !==
                                    a.mobile.path.makeUrlAbsolute(f) ||
                            ...
                            for (
                                ...
                                (k = v.eq(i)),
                                    ...
                                    (f || this._processListItem(k)) &&
                                        ((q = this._getChildrenByTagName(
                                            k[0],
                                            "a",
                                            "A"
                                        )),
                                        (r =
                                            "list-divider" === e(k[0], "role")),
                                        (s = k.attr("value")),
                                        (n = e(k[0], "theme")),
                                        q.length &&
                                        ((this._processListItemAnchor(q) &&
                                            !r) ||
                                            f)
                                            ? ((o = e(k[0], "icon")),
                                              (p = o === !1 ? !1 : o || A.icon),
                                              ...
                                              q.length > 1
                                                  ? ((l +=
                                                        " ui-listview-item-has-alternate"),
                                                    (t = q.last()),
                                                    (u =
                                                        e(t[0], "theme") ||
                                                        A.splitTheme ||
                                    ...
                                    b(E, k[0], l, m);
                            for (w in E)
                                this._addClass.apply(
                                    this,
                                    [a(E[w])].concat(w.split("|"))
                                );
                            this._addClass(
                                v.filter(c),
                    ...
                    b.preventDefault(),
                        (h && !e.collapsible) ||
                            ...
                            e.icons &&
                                ...
                                )._addClass(c, null, e.icons.header)),
                            h ||
                                (this._removeClass(
                                    g,
                                    "ui-accordion-header-collapsed"
                                ...
                                e.icons &&
                                    ...
                                    this._removeClass(
                                        ...
                                        null,
                                        e.icons.header
                                    )._addClass(d, null, e.icons.activeHeader)),
                                this._addClass(
                                    g.next(),
                                    "ui-accordion-content-active"
                                )));
                            ...
                            : c.length &&
                              this.headers
                                  .filter(function () {
                                      return (
                                          0 ===
                                          parseInt(a(this).attr("tabIndex"), 10)
                                      );
                                  })
                                  .attr("tabIndex", -1),
                        c
                ...
                _toggleComplete: function (a) {
                    ...
                    this._removeClass(b, "ui-accordion-content-active"),
                        this._removeClass(
                            c,
                            "ui-accordion-header-active"
                        )._addClass(c, "ui-accordion-header-collapsed"),
                        b.length &&
                ...
                ? (a.widget("ui.button", a.ui.button, {
                      ...
                      _seticonpos: function (a) {
                          "right" === a
                              ...
                              : "left" !== a &&
                                this._setOption("iconPosition", a);
                      },
                      _setOption: function (a, b) {
                          ("iconPosition" === a || "iconpos" === a) &&
                              this["_set" + a](b),
                              this._superApply(arguments);
                      },
                  }),
                ...
                a.widget("mobile.textinput", {
                    ...
                    options: {
                        classes: {
                            ...
                            "ui-textinput-search-icon":
                                "ui-icon ui-alt-icon ui-icon-search",
                        },
                        theme: "inherit",
                        preventFocusZoom:
                    ...
                    _enhance: function () {
                        ...
                        this.isTextarea
                            ...
                            : ((b = a("<div>")),
                              this.isSearch &&
                                  (this._searchIcon = a("<span>").prependTo(
                                      b
                                  ))),
                            (this._outer = b),
                            this.isTextarea ||
        ...
        (function (b) {
            ...
            return a.widget("mobile.textinput", a.mobile.textinput, {
                ...
                _toggleClear: function () {
                    this._toggleClearDelay = this._delay(
                        "_toggleClearClass",
                        0
                    );
                },
            ...
            var c = a.widget("mobile.selectmenu", [
                {
                    ...
                    _create: function () {
                        ...
                        this._preExtension(),
                            ...
                            (c.disabled || this.element.prop("disabled")) &&
                                this.disable(),
                    ...
                    setButtonText: function () {
                        ...
                        this.button
                            .children("span")
                            .not(
                                ".ui-selectmenu-count-bubble,.ui-selectmenu-button-icon"
                            )
                            .remove()
                            .end()
                            .end()
                    ...
                    _setOptions: function (a) {
                        a.addBackBtn && this._updateBackButton(),
                            a.backBtnText !== d &&
                                this.element
                                    .find(
                                        ".ui-toolbar-back-button .ui-button-text"
                                    )
                                    .text(a.backBtnText),
                            this._super(a);
                    },
            ...
            return a.widget("mobile.selectmenu", a.mobile.selectmenu, {
                ...
                build: function () {
                    ...
                    return (
                        ...
                        (l =
                            w.dividerTheme &&
                            this.element.children("optgroup").length > 0
                                ? " data-" +
                                  this._ns() +
                                  "divider-theme='" +
                                  w.dividerTheme +
                ...
                refresh: function (b) {
                    ...
                    return this.options.nativeMenu
                        ? this._super(b)
                        : ((b || this._isRebuildRequired()) &&
                              this._buildList(),
                          (c = this.selectedIndices()),
                          this.setButtonText(),
                          this.setButtonCount(),
                          (d = this.list.find(
                              "li:not(.ui-listview-item-divider)"
                          )),
                          this._removeClass(
                              d.find("a"),
                              null,
                ...
                close: function () {
                    !this.options.disabled &&
                        this.isOpen &&
                        ("page" === this.menuType
                            ? this.menuPage.hasClass("ui-page-active") &&
                              a.mobile.back()
                        ...
                        ? (this.menuPage.appendTo(
                          ...
                          0 === f &&
                              ...
                              this.thisPage.one("pagehide", function () {
                                  a(this).data(
                                      a.camelCase(this._ns() + "lastScroll"),
                                      g
                                  );
                              }),
                          this._on(this.document, {
                        ...
                        this._super(),
                            this._on(this.document, {
                                pagecontainershow: function (b, c) {
                                    a.contains(c.toPage[0], this.element[0]) &&
                                        this.refresh();
                                },
                            });
                    },
        ...
        (function (b) {
            ...
            return a.widget("mobile.toolbar", a.mobile.toolbar, {
                ...
                _setOptions: function (b) {
                    if (
                        ...
                        b.fullscreen !== d &&
                            (b.fullscreen
                                ? (this._addClass(
                                      "ui-toolbar-" + this.role + "-fullscreen"
                                  ),
                                  this._addClass(
                                      e,
                                      "ui-toolbar-page-" +
                ...
                hide: function (b) {
                    var c =
                        "slide" === this.options.transition ? " reverse" : "";
                    this._useTransition(b)
                      ...
                      _workarounds: function () {
                          ...
                          a.indexOf("Android") > -1 &&
                              ...
                              "android" === d &&
                                  c &&
                                  534 > c &&
                                  (e._bindScrollWorkaround(),
                                  e._bindListThumbWorkaround()));
                      },
                      _viewportOffset: function () {
                          var a = this.element,
                              b = a.hasClass("ui-toolbar-header"),
                              c = Math.abs(
                                  a.offset().top - this.window.scrollTop()
                              );
                          return (
                              b ||
                                  (c =
        ...
        (function (b) {
            ...
            return (
                a.mobileBackcompat !== !1 &&
                    ...
                    (a.mobile.popup.prototype._boolOptions.shadow =
                        "ui-overlay-shadow")),
                a.mobile.popup
            );
        }),
            ...
            return a.widget("mobile.popup", a.mobile.popup, {
                ...
                _create: function () {
                    ...
                    return (
                        this.options.arrow &&
                            (this.options.enhanced
                                ? ((a = {
                                      gd: this.element.children(
                                          ".ui-popup-arrow-guide"
                                      ),
                                      ct: this.element.children(
                ...
                _setOptions: function (a) {
                    ...
                    if (a.arrow !== d) {
                        ...
                        b &&
                            !a.arrow &&
                            (b.arEls.remove(), delete this._ui.arrow);
                    }
                    return c;
                },
                _destroy: function () {
                ...
                a.mobileBackcompat !== !1 &&
                    a.widget("mobile.popup", a.mobile.popup, {
                        _setInitialOptions: function () {
                            ...
                            this._super(),
                                b["ui-popup-arrow"] ===
                                    a[this.namespace][this.widgetName].prototype
                                        .options.classes["ui-popup-arrow"] &&
        ...
        (function (b) {
            ...
            return a.widget("mobile.panel", {
                ...
                _getPanelClasses: function () {
                    ...
                    return (
                        this.options.positionFixed && (a += " ui-panel-fixed"),
                        a
                    );
                },
                ...
                _positionPanel: function (b) {
                    ...
                    g || !e.options.positionFixed
                        ? (g
                              ? (e._unfixPanel(),
                                a.mobile.resetActivePageHeight(f))
                              : this._parentPage ||
                          ...
                          b !== !0 ||
                              a.mobile.isElementCurrentlyVisible(
                                  ".ui-content"
                              ) ||
                                ...
                                c._off(c.document, "panelclose"),
                                    ...
                                    !b && a.support.cssTransform3d && d.animate
                                        ? (
                                          ...
                                          ).animationComplete(e, "transition")
                                        : setTimeout(e, 0),
                                    d.theme &&
                                        "overlay" !== d.display &&
                                        c._addClass(
            ...
            return a.widget("mobile.table", {
                ...
                _refreshHeaderCell: function (b, c, d) {
                    ...
                    return (
                        a(c).jqmData(
                            "cells",
                            this.allRowsExceptFirst.not(c).children(g)
                        ),
                        d
                    );
                },
                ...
                refresh: function () {
                    this._setHeaders(),
                        this.headerRows.each(
                            a.proxy(this, "_refreshHeaderRow")
                        );
                },
                _destroy: function () {
                    var b = this.element;
                            ...
                            (this.options.enhanced ||
                                this.headers.each(
                                    a.proxy(function (b, c) {
                                        var d,
                                            e = a.mobile.getAttribute(
                                                c,
                                                "priority"
                                            );
                                        e &&
                                            ((d = a(c)),
                                            d.add(d.jqmData("cells")));
                                    }, this)
                                )),
                        this._superApply(arguments)
                    );
        ...
        (function (b) {
            ...
            return a.widget("mobile.table", a.mobile.table, {
                ...
                _create: function () {
                    var b, c;
                    (this.options.columnButtonTheme = this.options
                        .columnButtonTheme
                        ...
                        "columntoggle" === this.options.mode &&
                            ...
                            ((b = this._id()),
                            (c = a(
                                this.document[0].getElementById(b + "-popup")
                            )),
                            (this._ui = {
                                popup: c,
                            ...
                            b &&
                                (null != a.disabled &&
                                    ...
                                    this._ui.button &&
                                        ...
                                        a.disabled
                                            ? this._ui.button.attr(
                                                  "tabindex",
                                                  -1
                                              )
                                            : this._ui.button.removeAttr(
                                                  "tabindex"
                                              ))),
                                ...
                                null != a.columnButton &&
                                    (a.columnButton
                                        ? ((this._ui.button &&
                                              0 !== this._ui.button.length) ||
                                              (this._ui.button = this._columnsButton()),
                                          this._ui.button.insertBefore(
                                              this.element
                                          ))
                                        : this._ui.button &&
                ...
                _addColumnUI: function (b) {
                    ...
                    return (
                        ...
                        (c = this._ui = {
                            button: this.options.columnButton
                                ? this._columnsButton()
                                : null,
                ...
                _handleButtonClicked: function (b) {
                    a.mobile.popup.handleLink(this._ui.button),
                        b.preventDefault();
                },
        ...
        (function (b) {
            ...
            return a.widget("mobile.filterable", {
                ...
                _filterItems: function (b) {
                    ...
                    if (null != b)
                        for (
                            e = j.filterCallback || c, f = k.length, d = 0;
                            f > d;
                            d++
                        )
                ...
                _setInput: function (c) {
                    ...
                    this._timer &&
                        ...
                        d &&
                            (this._off(
                                d,
                                "keyup keydown keypress change input"
                            ),
                            (d = null)),
                        c &&
                            ((d = c.jquery
                ...
                a.widget("ui.tabs", {
                    ...
                    _processTabs: function () {
                        var b = this,
                            ...
                            d = this.anchors,
                            e = this.panels;
                        (this.tablist = this._getList().attr(
                            "role",
                            "tablist"
                        )),
                            this._addClass(
                            ...
                            this.anchors.each(function (c, d) {
                                ...
                                b._isLocal(d)
                                    ? ((e = d.hash),
                                      (g = e.substring(1)),
                                      (f = b.element.find(
                                          b._sanitizeSelector(e)
                                      )))
                                    : ((g =
                                          i.attr("aria-controls") ||
                                          a({}).uniqueId()[0].id),
                                      (e = "#" + g),
                                      (f = b.element.find(e)),
                                      f.length ||
            ...
            return a.widget("ui.tabs", a.ui.tabs, {
                ...
                _isLocal: function (b) {
                    ...
                    return a.mobile.ajaxEnabled
                        ? ((c = a.mobile.path),
                          (d = c.parseUrl(
                              a.mobile.base.element().attr("href")
                          )),
                          (e = c.parseUrl(
                              c.makeUrlAbsolute(b.getAttribute("href"), d)
                          )),
                          c.isSameDomain(e.href, d.href) &&
                    ...
                    a.extend(a.mobile, {
                        initializePage: function () {
                            var b,
                                ...
                                i = f.stripHash(
                                    f.stripQueryParams(f.parseLocation().hash)
                                ),
                                ...
                                h.each(function () {
                                    ...
                                    b[0].getAttribute(
                                        ...
                                        b.attr(
                                            "data-" + a.mobile.ns + "url",
                                            b.attr("id") ||
                                                f.convertUrlToDataUrl(
                                                    j.pathname + j.search
                                                )
                                        );
                                }),
                                (a.mobile.firstPage = h.first()),
                                (b = a.mobile.firstPage
                                    .parent()
                                    .pagecontainer()),
