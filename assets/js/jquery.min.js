...
$(".inundacion").hover(function () {
    $(".inundacionbg").fadeToggle(325);
});

$(".inundacion").hover(
    function () {
        $(".inundacionbg img").css("transform", "scale(1.5)");
    },
    function () {
        $(".inundacionbg img").css("transform", "");
    }
);

// $(".inundacion").hover(
//     function () {
//         $(".inundacionbg img").css("opacity", "0.35");
//     },
//     function () {
//         $(".inundacionbg img").css("transform", "");
//     }
